...
with open(colabpath, 'r', encoding='utf-8') as f:
    for line in f:
        ...
        if stripped_line.startswith(r'"%cd /content/drive/mydrive/feliz'):
            startcapture = True
        if startcapture:
            ...
            if stripped_line.startswith('apt -y install'):
                ...
                if stripped_line.endswith(camendururepo):
                  ...
                  currentpart = 'part2_1'
                # print("[1;33mprepare " + currentpart + "[0m: " + stripped_line)
            elif stripped_line.startswith("%cd /content/drive/mydrive/feliz/stable-diffusion-webui"):
                currentpart = "part2_2"
                # print("[1;33mprepare " + currentpart + "[0m: " + stripped_line)
...
if extensiontoremove:
    ...
    if not emptymodel:
        for ext in extensiontoremove:
            extpath = os.path.join('/content/drive/mydrive/feliz/volatile-concentration-localux/extensions', ext)
